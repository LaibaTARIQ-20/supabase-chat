    ...
    <main className="min-h-screen flex items-center justify-center p-4 bg-base">
      <div className="w-full max-w-md bg-surface border border-border-subtle rounded-2xl p-8 shadow-2xl">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-xl font-semibold text-content-primary">Join the chat</h1>
          <p className="text-sm text-content-secondary mt-1">Create your free account</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          {message && <p className="p-3 rounded-lg bg-accent-soft text-accent text-sm">{message}</p>}
